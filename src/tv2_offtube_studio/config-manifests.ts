import { ConfigManifestEntry, ConfigManifestEntryTable, ConfigManifestEntryType, TSR } from 'blueprints-integration'
import { DSKConfigManifest, MakeConfigForSources, MakeConfigWithMediaFlow } from 'tv2-common'
...
// const DEFAULT_STUDIO_MICS_LAYERS = [ // TODO C
...
export const manifestOfftubeSourcesABMediaPlayers: ConfigManifestEntryTable = {
	...
	required: false,
	// defaultVal: literal<Array<TableConfigItemSourceMapping & TableConfigItemValue[0]>>([ // TODO C
	// 	{
	// 		_id: '',
	// 		SourceName: '1',
	// 		AtemSource: 5
...
export const manifestOfftubeStudioMics: ConfigManifestEntry = {
	...
	required: true,
	multiple: true
	// defaultVal: DEFAULT_STUDIO_MICS_LAYERS // TODO C
}
...
export const studioConfigManifest: ConfigManifestEntry[] = [
	...
	},
	{
		...
		type: ConfigManifestEntryType.INT,
		required: true
		// defaultVal: AtemSourceIndex.Col1 // TODO C
	},
	{
		...
		type: ConfigManifestEntryType.INT,
		required: true
		// defaultVal: AtemSourceIndex.Col2 // TODO C
	},
	{
		id: 'AtemSource.Dip',
	...
	},
	{
		...
		type: ConfigManifestEntryType.INT,
		required: true
		// defaultVal: 200 // 5 frames // TODO C
	},
	{
	...
	},
	{
		...
		multiple: true,
		// defaultVal: [OfftubeSisyfosLLayer.SisyfosSourceLive_1_Stereo, OfftubeSisyfosLLayer.SisyfosSourceLive_1_Surround], // TODO C
		required: true
	},
	{
